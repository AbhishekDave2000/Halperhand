...
CREATE TABLE `usersfavorites` (
  ...
  `favorite_for` int(200) NOT NULL,
  `favorite_user` int(200) NOT NULL,
...
ALTER TABLE `notification`
  ...
  ADD KEY `notificationservice` (`service_id`);
...
ALTER TABLE `service`
  ...
  ADD KEY `serviceaddress` (`address_id`),
  ADD KEY `serviceacceptedbyprovider` (`service_accept_by_id`);
...
ALTER TABLE `serviceprovider`
  ...
  ADD KEY `servicepro` (`provider_id`);
...
ALTER TABLE `usersaddress`
  ...
  ADD KEY `addressuserid` (`user_id`),
  ADD KEY `addresscityid` (`city_id`);
...
ALTER TABLE `usersfavorites`
  ...
  ADD KEY `favfor` (`favorite_for`),
  ADD KEY `favuser` (`favorite_user`);
...
--
ALTER TABLE `serviceprovider`
  MODIFY `sp_id` int(200) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `notification`
  ADD CONSTRAINT `notificationservice` FOREIGN KEY (`service_id`) REFERENCES `service` (`service_id`);

--
-- Constraints for table `providerrating`
--
ALTER TABLE `providerrating`
  ADD CONSTRAINT `prorating` FOREIGN KEY (`service_id`) REFERENCES `service` (`service_id`);
...
ALTER TABLE `service`
  ...
  ADD CONSTRAINT `serviceacceptedbyprovider` FOREIGN KEY (`service_accept_by_id`) REFERENCES `serviceprovider` (`sp_id`),
  ADD CONSTRAINT `serviceaddress` FOREIGN KEY (`address_id`) REFERENCES `usersaddress` (`address_id`);

--
-- Constraints for table `serviceprovider`
--
ALTER TABLE `serviceprovider`
  ADD CONSTRAINT `servicepro` FOREIGN KEY (`provider_id`) REFERENCES `users` (`user_id`);

--
-- Constraints for table `usersaddress`
--
ALTER TABLE `usersaddress`
  ADD CONSTRAINT `addresscityid` FOREIGN KEY (`city_id`) REFERENCES `city` (`city_id`),
  ADD CONSTRAINT `addressuserid` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`);

--
-- Constraints for table `usersfavorites`
--
ALTER TABLE `usersfavorites`
  ADD CONSTRAINT `favfor` FOREIGN KEY (`favorite_for`) REFERENCES `users` (`user_id`),
  ADD CONSTRAINT `favuser` FOREIGN KEY (`favorite_user`) REFERENCES `users` (`user_id`);
COMMIT;
