            ...
            <form class="mySetting-Detail-Form">
                <div class="container-fluid pt-2 pb-4" style="border-bottom: 1px solid #acacac;">
                    ...
                    <div class="row pt-3">
                        ...
                        <div class="col-md-4 pl-0 pt-2">
                            <label class="form-label" for="Nationallity-of-provider">Nationallity</label>
                            <select class="form-select mt-2" id="country" name="country">
                                <option value="Nationallity">Nationallity</option>
                ...
                <div class="container-fluid pt-3 pb-3 pl-0">
                    <div class="row pt-3">
                        <div class="col">
                ...
                <div class="avatar-basic-main-div">
                    <div class="col pl-0 mr-2 basic-detail-head">My Address</div>
                </div>
