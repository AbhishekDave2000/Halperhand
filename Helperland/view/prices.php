...
<body>
    ...
    <section class="prices">
        <div class="container-fluid" style="padding-left: 0 !important; padding-right: 0 !important; margin: 0;">
            <div class="container" id="heading-faq">
                ...
                <div class="onetime-division">
                    <div class="one-time-head">
                        <span class="One-Time">
                            One Time
                        </span>
                    </div>
                    <div class="one-time-body">
                        <div class="one-body-1">

                            <span class="text-style-1"><img
                                    src="https://img.icons8.com/windows/32/000000/euro-pound-exchange.png" />20</span>/hr
                        </div>
                ...
                <div class="container" id="heading-service">
                ...
                <div class="container" id="services-division">
    ...
    <section class="cleaning">
        <div class="container" id="include-clean">
            <div id="FAQ">
                Prices
            </div>
            <div class="star-logo">
    ...
    <!-- cleaning includes end -->


    <!-- reason -->
    <section class="reason-division">
        <div id="FAQ">
            Why Helperland
        </div>
        <div class="star-logo">
        ...
        <div class="container" id="why-card">
            <div class="why-card-1 card-1">
                <p>
            ...
            <div class="why-card-1 card-1" id="card-3">
                <p>
                <p class="Every-cleaning-is-insured">
                    Every cleaning is insured
                </p>
                <p class="and-seek-to-provide-exceptional-service-and-engage-in-proactive">
                    and seek to provide exceptional service and engage in proactive behavior. We‘d be happy to clean
                    your homes.
                </p>
                </p>
                <p>
                <p class="Secure-online-payment">
                    Secure online payment
                </p>
                <p class="Payment-is-processed-securely-online-Customers-pay-safely-onli">
