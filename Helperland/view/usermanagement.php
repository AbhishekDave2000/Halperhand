    ...
    <div class="container-fluid content">
        ...
        <aside class="container__sidebar container-fluid">
            <ul class="nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="servicerequest.php">Service Requests</a>
                </li>
            </ul>
        </aside>
        ...
        <main class="container__main container-fluid">
            ...
            <div class="container-fluid heading-class">
                ...
                <div>
                    <button type="button" class="btn">
                        <img class="add-button" src="Img/admin/add.png" alt=""> Add New User
                    </button>
                </div>
            </div>
            ...
            <div class="container-fluid third-div">
                <table id="example" class="table-data" style="width:100%">
                    <thead>
                        <tr>
                            <th class="username">User Name<img src="Img/admin/sort.png" alt="" class="sorting-img"></th>
                            <th class="usertype">User Type <img src="Img/admin/sort.png" alt="" class="sorting-img">
                            </th>
                            <th class="role">Role</th>
                            <th class="postalcode">Postal Code <img src="Img/admin/sort.png" alt="" class="sorting-img">
                            </th>
                            <th class="city">City</th>
                            <th class="radius">Radius <img src="Img/admin/sort.png" alt="" class="sorting-img"></th>
